    ...
    Out: std::io::Write,
{
    ...
    fn write<S: std::fmt::Display>(
        ...
        match (fg, bg) {
            ...
            (None, Some(Color::Black)) => write!(self.out, "[4{}m{txt}", self.sub),
            ...
            (Some(Color::Reset), Some(Color::Black)) => write!(self.out, "[;4{}m{txt}", self.sub),
            (Some(Color::Reset), Some(bg)) => write!(self.out, "[;4{bg}m{txt}"),
            (Some(fg), Some(Color::Black)) => write!(self.out, "[3{fg};4{}m{txt}", self.sub),
